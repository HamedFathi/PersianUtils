export class Jalaali {
  ...
  */
  ...
  public static toJalaali(
    year: number | Date,
    month?: number,
    day?: number
  ): Ijdate {
    const date = convertFromDate(year, month, day);
    return Jalaali.d2j(Jalaali.g2d(date.year, date.month || 1, date.day || 1));
  }
  ...
  */
  ...
  public static toGregorian(
    ...
    const date = convertFromDate(year, month, day);
    return Jalaali.d2g(Jalaali.j2d(date.year, date.month || 1, date.day || 1));
  }

  /*
    Checks whether a Jalaali date is valid or not.
  */
  public static isValidJalaaliDate(
    year: number,
    month: number,
    day: number
  ): boolean {
    return (
      ...
      month <= 12 &&
      day >= 1 &&
      day <= Jalaali.jalaaliMonthLength(year, month, day)
    );
  }
  ...
  */
  public static jalaaliMonthLength(
    year: number,
    month: number,
    day: number
  ): number {
